	...
	if($result -> num_rows == 0){
		...
		if($result -> num_rows == 0){
			...
			if ($conn->query($sql) === TRUE) {
				...
				$msg = "Dear " . $row['email'] . " <br><br>. $email wants to be a collaborator on your experiment at $location. If you are okay with this, please go to the following link: <br><br> $imploded_url/collaborator.php?email=$email&location=$location";
